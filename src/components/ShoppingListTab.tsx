...
import { ShoppingCart, ChevronDown, Check, Trash2, Edit2, X, Info, CheckSquare, Square } from 'lucide-react';
        ...
        <>
          {isEditMode && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="sticky top-[88px] z-30 bg-white shadow-lg rounded-xl overflow-hidden"
            >
              <button
              ...
              >
                <div className="relative w-6 h-6">
                  {selectedLists.size === lists.length ? (
                    <CheckSquare className="w-6 h-6 text-[#34C759]" />
      ...
      <AnimatePresence>
        ...
        {showMultiDeleteConfirm && (
          ...
          >
            ...
            >
              <h3 className="text-lg font-bold text-gray-900 mb-4">
                選択した{selectedLists.size}件のリストを削除しますか？
              </h3>
              <p className="text-gray-600 mb-6">
                この操作は取り消せません。
              </p>
